        ...
        for (let minute of eventMinutes) {
            ...
            if (playerPowerValue > enemyPowerValue) {
                ...
                if (goal) {
                    ...
                    goals = { ...goals, player: goals.player + 1 }
                }
            } else {
                ...
                if (goal) {
                    ...
                    goals = { ...goals, enemy: goals.enemy + 1 }
                }
            }
        }
            ...
            <div className='field-activities'>
                ...
                <div className='match-activities'>
                    {activities?.map((event) => {
                        return (
                            <label className={`${event.actor}-event `}>{event.minute}' {event.description}</label>
                        )
                    })}
                </div>
                <button onClick={() => simulateMatch()}>Start Game</button>
            </div>
            <div className='team-list'>
